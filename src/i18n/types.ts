...
export interface TranslationDictionary {
  ...
  sort_sell_high: string;
  sort_sell_low: string;
  sort_exp_high: string;
  filter_and_simulation: string;
  empty_no_matching_fish: string;
  gear_skill_level: string;
  gear_rod_label: string;
  gear_bait_label: string;
  gear_tackle_label: string;
  gear_reeling_power: string;
  gear_line_tension: string;
  gear_bait_bonus: string;
  gear_lvl_master: string;
  altar_header_main_title: string;
  altar_total_progress: string;
  altar_filter_all: string;
  altar_required_for: string;
  map_main_title: string;
  map_edit_pins: string;
  map_preview_title: string;
  map_fishing_spots: string;
  minigame_catch_label: string;
  minigame_practice_again: string;
  minigame_try_again: string;
  wiki_empty_buildings: string;
  wiki_empty_crafting: string;
  wiki_showing_count: string;
  wiki_structures_subtitle: string;
  wiki_crafting_subtitle: string;
  wiki_sort_name: string;
  wiki_sort_level: string;
  wiki_sort_cost: string;
  save_import_main_title: string;
  save_import_main_subtitle: string;
  save_import_success: string;
  save_import_caught: string;
  save_import_museum: string;
  save_import_altars: string;
  save_import_where_file: string;
  stats_total_cataloged: string;
  stats_donated_museum: string;
  stats_altar_restored: string;
  stats_rod_path_title: string;
  stats_mastery_title: string;
}
