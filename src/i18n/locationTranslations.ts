...
export const LOCATION_TRANSLATIONS: Record<string, Partial<Record<SupportedLanguage, string>>> = {
  ...
  'Rice Field': { pt: 'Plantação de Arroz', es: 'Arrozal', de: 'Reisfeld', fr: 'Rizière', zh: '稻田', ja: '水田', id: 'Sawah' },
  'Pond': { pt: 'Lagoa', es: 'Estanque', de: 'Teich', fr: 'Étang', zh: '池塘', ja: '池', id: 'Kolam' },
  'Cave Entrance': { pt: 'Entrada da Caverna', es: 'Entrada de la Cueva', de: 'Höhleneingang', fr: 'Entrée de la Grotte', zh: '矿洞入口', ja: '洞窟の入口', id: 'Pintu Masuk Gua' },
  ...
  'Ocean Dock': { pt: 'Docas do Oceano', es: 'Muelles del Océano', de: 'Ozean-Docks', fr: 'Quais de l’Océan', zh: '海港码头', ja: '港の海', id: 'Dermaga Samudra' },
  'Ocean Forest': { pt: 'Floresta Oceânica', es: 'Bosque Oceánico', de: 'Ozeanwald', fr: 'Forêt Océanique', zh: '海洋森林', ja: '海の森', id: 'Hutan Samudra' },
