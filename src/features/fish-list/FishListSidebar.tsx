...
import { Search, Flame, RotateCcw, SlidersHorizontal, ChevronDown, ChevronUp } from 'lucide-react';
...
export const FishListSidebar: React.FC = () => {
  ...
  return (
    <aside className="glass-panel p-4 shadow-xl text-xs space-y-3">
      
      {/* Search & Mobile Collapsible Bar */}
      <div className="space-y-2">
        ...
        <button
          ...
          className="lg:hidden cg-pill w-full py-2 px-3 justify-between font-bold text-xs"
        >
      ...
      {/* Main Filter Panel Body (Always visible on Desktop, Collapsible on Mobile) */}
