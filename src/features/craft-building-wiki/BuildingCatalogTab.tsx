  ...
  if (buildings.length === 0) {
    return (
      <div className="bg-[#182228]/80 border border-white/10 rounded-2xl p-12 text-center space-y-3">
        ...
        <h3 className="text-base font-bold text-white">No Buildings Found</h3>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between text-xs text-[#c4b5a0] px-1">
        <div className="flex items-center gap-1.5 font-bold">
          ...
          <span>Showing <strong className="text-white">{buildings.length}</strong> Farm & Town Structures</span>
        </div>
